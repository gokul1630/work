...
// WorkerPool represents a pool of workers. It forms the primary API of gokul1630/work. WorkerPools provide the public API of gokul1630/work. You can attach jobs and middlware to them. You can start and stop them. Based on their concurrency setting, they'll spin up N worker goroutines.
